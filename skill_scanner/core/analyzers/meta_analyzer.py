        ...
        for attempt in range(self.max_retries):
            try:
                with external_span(
                    "llm",
                    "meta_analysis",
                    {"llm.model": str(self.model), "external.attempt": attempt + 1},
                ):
                ...
                record_external_error(
                    "llm",
                    "rate_limit" if "rate limit" in error_msg or "429" in error_msg else type(e).__name__,
                ...
                if attempt < self.max_retries - 1 and is_retryable:
                    ...
                    record_external_retry("llm", "retryable_error", operation="meta_analysis")
